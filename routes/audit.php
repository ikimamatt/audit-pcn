...
Route::prefix('audit')->name('audit.')->group(function () {
    ...
    Route::middleware(['auth', 'role:KSPI,ASMAN SPI,AUDITOR,SUPER ADMIN,VIEW BOD'])->group(function () {
        ...
        // --- Jadwal PKPT ---
        Route::resource('pkpt', JadwalPkptAuditController::class);
        ...
        Route::resource('pka', ProgramKerjaAuditController::class);
        ...
        // --- Exit Meeting ---
        Route::resource('exit-meeting', ExitMeetingController::class)->except(['show']);
        Route::post('exit-meeting/{id}/approval', [ExitMeetingController::class, 'approval'])->name('exit-meeting.approval');

        // --- Pelaporan Hasil Audit (CRUD hanya SPI) ---
        ...
        // --- Penutup LHA Rekomendasi (Modifikasi & Approval hanya SPI) ---
