...
class EntryMeetingController extends Controller
{
    ...
    public function approval($id, Request $request)
    {
        ...
        if ($request->action == 'approve') {
            ...
            $item->save();
            return redirect()->back()->with('success', 'Entry Meeting berhasil diapprove!');
            ...
            $item->save();
            return redirect()->back()->with('success', 'Entry Meeting berhasil ditolak dengan alasan: ' . $request->rejection_reason);
        }
