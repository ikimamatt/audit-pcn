    ...
    public function run(): void
    {
        ...
        $insertData = [
            [
                ...
                'koordinator_id' => $userIds[0] ?? null,
                'ketua_tim_id' => $userIds[1] ?? null,
                'created_at'           => now(),
                'updated_at'           => now(),
            ],
            [
        ...
        DB::table('perencanaan_audit')->insert($insertData);
    }
}