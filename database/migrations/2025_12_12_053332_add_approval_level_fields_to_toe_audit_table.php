...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE toe_audit MODIFY COLUMN status_approval ENUM('pending', 'approved_level1', 'approved', 'rejected_level1', 'rejected') DEFAULT 'pending'");
    ...
    public function down(): void
    {
        Schema::table('toe_audit', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE toe_audit MODIFY COLUMN status_approval ENUM('pending', 'approved', 'rejected') DEFAULT 'pending'");
        });
    }
};
