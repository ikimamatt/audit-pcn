...
return new class extends Migration
{
    ...
    {
        // Modify status_approval enum using raw SQL (MySQL doesn't support direct enum modification)
        DB::statement("ALTER TABLE penutup_lha_rekomendasi MODIFY COLUMN status_approval ENUM('pending', 'approved_level1', 'approved', 'rejected_level1', 'rejected') DEFAULT 'pending'");
    ...
    public function down(): void
    {
        Schema::table('penutup_lha_rekomendasi', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE penutup_lha_rekomendasi MODIFY COLUMN status_approval ENUM('pending', 'approved', 'rejected') DEFAULT 'pending'");
        });
    }
};
