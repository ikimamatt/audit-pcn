...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pelaporan_temuan', function (Blueprint $table) {
            ...
            $table->foreignUuid('kode_aoi_id')->constrained('master_kode_aoi')->onDelete('restrict');
            $table->foreignUuid('kode_risk_id')->constrained('master_kode_risk')->onDelete('restrict');
