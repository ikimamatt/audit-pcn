...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE entry_meeting MODIFY COLUMN status_approval ENUM('pending', 'approved_level1', 'approved', 'rejected_level1', 'rejected') DEFAULT 'pending'");
    ...
    public function down(): void
    {
        Schema::table('entry_meeting', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE entry_meeting MODIFY COLUMN status_approval ENUM('pending', 'approved', 'rejected') DEFAULT 'pending'");
        });
    }
};
