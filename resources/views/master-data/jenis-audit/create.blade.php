@extends('layouts.vertical', ['title' => 'Tambah Jenis Audit'])
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Tambah Jenis Audit</li>
                </ol>
            </div>
            <h4 class="page-title">Tambah Jenis Audit</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('master.jenis-audit.store') }}" method="POST">
                    @csrf
