    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <i class="mdi mdi-alert-octagon-outline" style="font-size:1.4rem; color:#2d6a9f;"></i>
                <h2 class="mb-0">Master Kode Risk</h2>
            </div>
            <div class="subtitle">
                <i class="mdi mdi-home-outline me-1"></i>Home &rsaquo; Master Data &rsaquo; Kode Risk
            </div>
        </div>
        <a href="#" class="btn-add-em" data-bs-toggle="modal" data-bs-target="#createModal">
            <i class="mdi mdi-plus-circle"></i> Tambah Kode Risk
        </a>
    </div>
</div>
...
<div class="card table-card">
    <div class="card-header-custom d-flex align-items-center justify-content-between pb-3">
        <div class="d-flex align-items-center gap-2">
            ...
            <h5 class="mb-0">Daftar Kode Risk</h5>
        </div>
        ...
        <div class="table-responsive">
                            ...
                            <td>
                                <div class="action-wrap">
                                    <button type="button" class="btn-act btn-act-edit btn-edit-modal"
                                        ...
                                        title="Edit Kode Risk">
                                        <i class="mdi mdi-pencil"></i>
                                    </button>
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('master.kode-risk.destroy', $item->id) }}" method="POST" class="m-0">
                                        @csrf @method('DELETE')
                                        <button type="button"
                                                class="btn-act btn-act-delete"
                                                onclick="deleteData('{{ $item->id }}')"
                                                title="Hapus Kode Risk">
            ...
            @if($data->isEmpty())
                <div class="empty-state">
                    ...
                    <p class="mb-0 fw-semibold">Belum ada data Kode Risk</p>
                    <p class="mb-0" style="font-size:.82rem;">Klik tombol <strong>Tambah Kode Risk</strong> untuk memulai</p>
                </div>
            @endif
        </div>
    </div>
