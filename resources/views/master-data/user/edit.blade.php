                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="{{ old('email', $masterUser->email) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="no_telpon" 
                                       name="no_telpon" 
                                       value="{{ old('no_telpon', $masterUser->no_telpon) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="jabatan" 
                                       name="jabatan" 
                                       value="{{ old('jabatan', $masterUser->jabatan) }}" 
                                ...
                                <select class="form-select @error('master_area_id') is-invalid @enderror" 
                                    ...
                                    @foreach($areas as $area)
                                        <option value="{{ $area->id }}" 
                                                {{ old('master_area_id', $masterUser->master_area_id) == $area->id ? 'selected' : '' }}>
