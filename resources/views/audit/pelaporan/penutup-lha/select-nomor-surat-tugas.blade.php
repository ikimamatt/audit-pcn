            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        Silakan pilih nomor surat tugas untuk melihat rekomendasi penutup LHA/LHK.
                    </div>

                    <!-- Filter Section -->
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="btn btn-secondary">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-info">{{ $item['count_temuan'] }} temuan</span>
                                        </td>
                                        <td>
                                            <a href="{{ route('audit.penutup-lha-rekomendasi.index', ['nomor_surat_tugas' => $item['nomor_surat_tugas']]) }}" 
                                               class="btn btn-primary btn-sm">
                                                <i class="mdi mdi-eye me-1"></i>Lihat Rekomendasi
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
                    ...
                    @else
                        <div class="alert alert-warning">
                            ...
                            @if(request('search') || request('jenis_audit'))
                                ...
                                <a href="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="alert-link">Reset filter</a>
                            @else
