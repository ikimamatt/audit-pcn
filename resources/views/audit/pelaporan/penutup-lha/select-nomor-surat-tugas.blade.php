            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 fs-12">
                        ...
                        <li class="breadcrumb-item text-muted">Penutup LHA</li>
                ...
                <div class="subtitle">Silakan pilih nomor surat tugas di bawah ini untuk mengelola rekomendasi penutup LHA/LHK.</div>
            </div>
            <div>
    ...
    <div class="col-md-10">
        ...
        <div class="card filter-card">
            <div class="card-body py-3">
                <form method="GET" action="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="row g-2 align-items-end">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="btn btn-custom btn-secondary flex-grow-1" style="padding: 9px 14px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info">
                                            ...
                                            {{ $item['count_temuan'] }} temuan
                                        </span>
                                    </td>
                                    <td>
                                        <a href="{{ route('audit.penutup-lha-rekomendasi.index', ['nomor_surat_tugas' => $item['nomor_surat_tugas']]) }}" 
                                           class="btn-custom-go btn-sm">
                                            <i class="mdi mdi-eye"></i> Lihat Rekomendasi
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <div class="p-4 text-center">
                        <div class="alert alert-warning border-warning border-opacity-25 mb-0" style="border-radius: 8px; display: inline-block;">
                            ...
                            @if(request('search') || request('jenis_audit'))
                                ...
                                <a href="{{ route('audit.penutup-lha-rekomendasi.select-nomor-surat-tugas') }}" class="alert-link text-decoration-none ms-1 font-weight-700">Reset filter</a>
                            @else
                                Belum ada nomor surat tugas yang memiliki temuan yang sudah diapprove.
                            @endif
                        </div>
                    </div>
                @endif
