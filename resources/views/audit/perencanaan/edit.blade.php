                ...
                <form id="form-perencanaan-audit" method="POST" action="{{ route('audit.perencanaan.update', $item->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="koordinator_id" id="koordinator_id" class="form-select select2-search" required>
                            ...
                            @foreach($auditors as $auditor)
                                <option value="{{ $auditor->id }}" {{ old('koordinator_id', $item->koordinator_id) == $auditor->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="ketua_tim_id" id="ketua_tim_id" class="form-select select2-search" required>
                            ...
                            @foreach($auditors as $auditor)
                                <option value="{{ $auditor->id }}" {{ old('ketua_tim_id', $item->ketua_tim_id) == $auditor->id ? 'selected' : '' }}>
                                    {{ $auditor->nama }} - {{ $auditor->nip }}
                                </option>
                            @endforeach
                        </select>
