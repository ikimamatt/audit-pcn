        ...
        <tr>
            ...
            <td>
                @if(request('edit') == $ev->id)
                    <form action="{{ route('audit.toe-evaluasi.update', $ev->id) }}" method="POST" style="display:inline-block">
                        @csrf @method('PUT')
            ...
            <td>
                <form action="{{ route('audit.toe-evaluasi.update', $ev->id) }}" method="GET" style="display:inline-block">
                ...
                <form action="{{ route('audit.toe-evaluasi.destroy', $ev->id) }}" method="POST" style="display:inline-block" class="delete-form">
                    @csrf @method('DELETE')
                    <input type="hidden" name="toe_audit_id" value="{{ $toe->id }}">
